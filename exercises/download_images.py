# task: https://www.linkedin.com/learning/python-parallel-and-concurrent-programming-part-2/challenge-download-images-in-python?resume=false&u=72605090
...
def par_download_images(image_numbers):
    results = Parallel(n_jobs=-1)(delayed(_download_image)(i) for i in image_numbers)
    return sum(results)
